...
var MongoClient, User, app, bodyParser, clientIdsByServerId, clientsIdsForUserId, commands, connection, doInit, env, executeCommand, express, mongoDb, mysql, parse, processLogsCol, request, resolveUserId, serverId, serverProcessId, snapshot, start, userIdForClientId, userIdsByClientId, winston, _,
...
executeCommand = function(type, params, sendResponse) {
  var commandResponse, logId, timestamp;
