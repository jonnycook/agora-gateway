...
var MongoClient, User, app, bodyParser, clientIdsByServerId, clientsIdsForUserId, commands, connection, doInit, domain, env, executeCommand, express, mongoDb, mysql, parse, processLogsCol, request, resolveUserId, serverId, serverProcessId, shuttingDown, snapshot, start, userIdForClientId, usersByClientId, validate, _,
  __slice = [].slice,
